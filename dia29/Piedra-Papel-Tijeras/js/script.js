...
function elegirAutomaticamente(){
    ...
    const numero = Math.floor(Math.random() * 3); //El numero esta entre 0 y 2 porque elige un numero de ente 0 y 1 lo mulitplica por 3 y redondea a la baja
...
function graficarBarra() {
    ...
    divPerdidas.style.width=porcentajeGanadas+"%";
}
